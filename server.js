...
function getUsers() {
  ...
  var user = new Person(randomUsername, 'hello', randomName, 25, 'LA', tweetsArray, "", followersArray, randomImage, "", "", notificationsArray, messagesArray, '');
  people.push(user);
  count++;
  if (count < 100) {
    getUsers();
...
function Tweet(name, username, tweet, id, likes, status, image, date, repostStatus, repostCount, repostId, imageTweet) {
  this.name = name;
...
function Favorite(x) {
  Tweet.call(this, x.name, x.username, x.tweet, x.id, x.likes, x.status, x.image, x.date, x.repostStatus, x.repostCount, x.repostId, x.imageTweet);
}
...
var followersArray1 = ["santadude", 'daffyduck', 'bugsbunny', 'ronalddude', 'mrtrump'];
var followersArray2 = ['hi'];
var followersArray3 = ['hi'];
var followersArray4 = ['hi'];
var followersArray5 = ['hi'];
var followersArray6 = ['hi'];
var followersArray7 = ['hi'];
var followersArray8 = ['hi'];
var followersArray9 = ['hi'];
var followersArray10 = ['hi'];
...
var repostArray8 = [];
var repostArray9 = [];
var tweet1 = new Tweet('Corey Lin', 'hi', '@santadude stop pretending to be santa!!!', 12305949305849, 23, 'unliked', "images/CL_2.jpg", new Date('April 1, 2016 03:24:00'), 'not-reposted', 0, 23529203692062, 'images/stock1.jpg');
var tweet2 = new Tweet('Corey Lin', 'hi', "kobes last game this week... #goat #legend #farewell #basketball #nbawon'tbethesame", 25949593040, 23, 'unliked', "images/CL_2.jpg", new Date('April 6, 2016 03:24:00'), 'not-reposted', 0, 2352032960302, 'images/kobefarewell.jpg');
...
var tweet8 = new Tweet('Corey Lin', 'hi', '#FYI if you hashtag a word in your post the trending words will be updated! try using #basketball', 0239847204987, 23, 'unliked', "images/CL_2.jpg", new Date('April 1, 2016 03:24:00'), 'not-reposted', 0, 404040444450325, 'images/legends.jpg');
...
tweetsArray2.push(new Tweet('Santa Claus', 'santadude', 'guys im real!!! yall are stupid! #onlykidsknow #onlykidsaresmart ', 1103948712098, 34, 'liked', 'images/santa.jpg', new Date('January 21, 2016 03:24:00'), 'not-reposted', 1, 23523224222, ''));
...
tweetsArray4.push(new Tweet('Donald Trump', 'mrtrump', 'Make america great again!!!! i #love america! truly! #trump2016', 1235029024, 23, 'liked', 'images/trump.jpg', new Date('March 22, 2016 03:24:00'), 'not-reposted', 1, 34566883222164, ''));
...
tweetsArray5.push(new Tweet('Bugs Bunny', 'bugsbunny', "What's up doc???", 1109841805, 0, 'liked', 'images/bugsbunny.jpg', new Date('January 06, 2016 03:24:00'), 'not-reposted', 0, 25347346214, 'images/bugs.gif'));
...
tweetsArray6.push(new Tweet('Daffy Duck', 'daffyduck', "It's #rabbit season. #eatrabbits #bunnies @bugsbunny", 110210505930, 1, 'liked', 'images/daffy.jpg', new Date('January 15, 2016 03:24:00'), 'not-reposted', 0, 235423423511, 'images/rabbitseason.jpg'));
...
var user1 = new Person('hi', 'hi', 'Corey Lin', 23, 'Los Angeles', tweetsArray1, followingArray1, followersArray1, 'images/CL_2.jpg', favoritesArray1, repostArray1, notificationsArray1, messagesArray1, '"I am the creator."');
var user2 = new Person('santadude', 'hello', 'Santa Claus', 200, 'North Pole', tweetsArray2, followingArray2, followersArray2, 'images/santa.jpg', favoritesArray1, repostArray2, notificationsArray2, messagesArray2, '"HO HO HO!"');
var user3 = new Person('ronalddude', 'hello', 'Ronald Mcdonald', 100, 'Mcdonalds', tweetsArray3, followingArray3, followersArray3, 'images/mcdonalds.png', favoritesArray1, repostArray3, notificationsArray3, messagesArray3, '"Try out our new yogurt parfait! Ba da da da da daaaa Im lovin it~"');
var user4 = new Person('mrtrump', 'hello', 'Donald Trump', 40, 'Orange County', tweetsArray4, followingArray4, followersArray4, 'images/trump.jpg', favoritesArray1, repostArray4, notificationsArray4, messagesArray4, '"Make America Great Again!!!"');
var user5 = new Person('bugsbunny', 'hello', 'Bugs Bunny', 252, 'Rabbit Hole', tweetsArray5, followingArray5, followersArray5, 'images/bugsbunny.jpg', favoritesArray1, repostArray5, notificationsArray5, messagesArray5, '"Whats up doc???"');
var user6 = new Person('daffyduck', 'hello', 'Daffy Duck', 252, 'Trees', tweetsArray6, followingArray6, followersArray6, 'images/daffy.jpg', favoritesArray1, repostArray6, notificationsArray6, messagesArray6, '"Its always rabbit season!"');
var user7 = new Person('chucknorris', 'hello', 'Chuck Norris', 235235, 'Washington', tweetsArray7, followingArray7, followersArray7, 'images/chucknorris.jpg', favoritesArray1, repostArray7, notificationsArray7, messagesArray7, '"Jesus can walk on water. I can swim on land."');
var user8 = new Person('dog', 'hello', 'Dog', 23423, 'Wyoming', tweetsArray8, followingArray8, followersArray8, 'images/dog.jpg', favoritesArray1, repostArray8, notificationsArray8, messagesArray8, '"woooooooof"');
...
app.get('/getmessages/:username', cookieParser(), function(req, res) {
  ...
  var currentUsername = req.cookies.session;
  var theTargetUser = _.find(people, {
    username: targetUsername
  });
  var theCurrentUser = _.find(people, {
    username: currentUsername
  });
  var correctMessages = [];
    ...
    if (userToFollow === people[g].username) {
      for (var x = 0; x < people.length; x++) {
        if (slicedUsername === people[x].username) {
          ...
          people[g].followers.push(userClient);
        }
      }
      res.sendStatus(200);
    }
...
app.post('/viewfollowing', jsonParser, function(req, res) {
  ...
  var followingNames = targetPerson.following;
  for (var p = 0; p < followingNames.length; p++) {
    var targetFollowing = _.find(people, {
      username: followingNames[p].user
    });
    users.push(targetFollowing);
  }
  res.send(users);
});

app.post('/viewfollowers', jsonParser, function(req, res) {
  var username = req.body.dashboardUsername;
  var slicedUsername = username.slice(1);
  var users = [];
  var targetPerson = _.find(people, {username: slicedUsername});
  var followerNames = targetPerson.followers;
  for (var p = 0; p < followerNames.length; p++) {
    var targetFollowers = _.find(people, {
...
app.get('/unfollow/:slicedUsername/:followingName', function(req, res) {
  var user = _.find(people, {
    username: req.params.slicedUsername
  });
...
app.get('/refollow/:slicedUsername/:reFollowName', function(req, res) {
  ...
  var userFollowing = user.following;
  var following = _.find(people, {
    username: req.params.reFollowName
  });
  userFollowing.push(new Following(following.username));
  following.followers.push(user.username);
  res.sendStatus(200);
});
